require 'huff_compress/heap'
require 'huff_compress/node'

RSpec.describe HuffCompress::Heap do

  let(:node_1) { HuffCompress::Node.new 1, 100 }
  let(:node_2) { HuffCompress::Node.new 2, 1 }
  let(:node_3) { HuffCompress::Node.new 3, 50 }
